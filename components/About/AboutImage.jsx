    ...
    <div className='relative w-full'>
      ...
      <div className='absolute top-4 right-4 z-[9999] pointer-events-auto'>
        <button
          ...
          className='mb-2 px-3 py-1 bg-black/80 text-white text-xs rounded hover:bg-black/90 transition-colors relative z-[10000]'
        >
          {showDebug ? "Hide" : "Show"} Debug
        </button>

        {showDebug && (
          <div className='bg-black/90 text-white p-4 rounded-lg text-xs min-w-[280px] space-y-4 relative z-[10000] pointer-events-auto'>
            <div>
              ...
              <input
                ...
                className='w-full cursor-pointer relative z-[10001]'
              />
            </div>

            <div>
              <label className='block mb-1'>
                Red Offset: {redOffset.toFixed(4)}
              </label>
              <input
                type='range'
                min='0'
            ...
            <div>
              <label className='block mb-1'>
                Green Offset: {greenOffset.toFixed(4)}
              </label>
              <input
                type='range'
                min='0'
                ...
                value={greenOffset}
                onChange={(e) =>
                  setGreenOffset(parseFloat(e.target.value))
                }
                className='w-full cursor-pointer relative z-[10001]'
              />
            </div>
            ...
            <div>
              <label className='block mb-1'>
                Blue Offset: {blueOffset.toFixed(4)}
              </label>
              <input
                type='range'
                min='0'
                ...
                value={blueOffset}
                onChange={(e) =>
                  setBlueOffset(parseFloat(e.target.value))
                }
                className='w-full cursor-pointer relative z-[10001]'
              />
            </div>
            ...
            <div className='pt-2 border-t border-white/20'>
              <button
                onClick={() => {
                  setRadius(0.25);
                  setRedOffset(0.02);
                  setGreenOffset(0.015);
                  setBlueOffset(0.02);
                }}
                className='w-full px-3 py-1 bg-white/20 hover:bg-white/30 rounded transition-colors relative z-[10001]'
              >
                Reset to Defaults
              </button>
            </div>
